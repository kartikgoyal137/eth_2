  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10">
      <header className="mb-6">
        <h1 className="text-balance text-3xl font-semibold">User 1 Upload</h1>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="grid gap-3">
          <Label htmlFor="match1">Match ID (share this with User 2 and the Judge)</Label>
          <Input
            id="match1"
      ...
      {isUploading && (
        <div className="mt-6">
          <LoadingBar direction="ltr" active={isUploading} checkpointsReached={checkpoints} />
        </div>
      )}
    </main>
  )
